...
class REPL extends EventEmitter {
  ...
  __writer(line) {
    ...
    if(line != null && line instanceof CursorResult) {
      return "======== render cursor results"
    }
  ...
  __eval(cmd, context, filename, callback) {
    ...
    co(function*() {
      ...
      if (cmd === 'exit' || cmd === 'quit') {
        ...
        // console.log("!!!!!!!!!!!!!!!!!!!!!!!!! CURSOR state :: " + self.context.__currentCursor.cursor.s.state)
      ...
      // console.log("======================================= EVAL")
      // console.log(`self.context.__currentCursor instanceof Cursor :: ${self.context.__currentCursor instanceof Cursor}`)
      // console.log(`cmd = ${cmd}`)
